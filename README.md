...
| --- | --- | --- | --- | --- |
| Decorative faceted tray | [Eight narrower facet patterns](model/faceted_storage_tray/README.md) | [Record](model/faceted_storage_tray/README.md#attribution) | N/A — full tray is the trial | Unknown — no user report |
