...
| --- | --- | --- | --- | --- |
| Decorative faceted tray | [Textured exterior variant](model/faceted_storage_tray/README.md) | [Record](model/faceted_storage_tray/README.md#attribution) | N/A — full tray is the trial | Unknown — no user report |
