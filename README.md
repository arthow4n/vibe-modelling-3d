...
| --- | --- | --- | --- | --- |
| Book reading plate | [PETG plate with recessed captive keys](model/book_reading_plate/README.md) | [Record](model/book_reading_plate/README.md#attribution) | Unknown — recessed lock test supplied; no user report | Unknown — no user report |
