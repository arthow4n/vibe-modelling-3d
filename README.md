...
| --- | --- | --- | --- | --- |
| Book reading plate | [PETG plate with two-piece sliding joint](model/book_reading_plate/README.md) | [Record](model/book_reading_plate/README.md#attribution) | Unknown — two-piece trial supplied; prior trial print unconfirmed | Unknown — no user report |
