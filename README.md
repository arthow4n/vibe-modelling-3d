...
| --- | --- | --- | --- | --- |
| Book reading plate | [PETG plate; recessed-screw joint trials](model/book_reading_plate/README.md) | [Record](model/book_reading_plate/README.md#attribution) | Partial — prior joint printed at 50%; socket unstable; recessed-screw trials unreported; A/B rejected | Unknown — no user report |
