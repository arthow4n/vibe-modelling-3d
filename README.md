...
| Rounded square tray | [Parametric tray and print instructions](model/rounded_square_tray/README.md) | [Record](model/rounded_square_tray/README.md#verification-and-provenance) | N/A — no separate test piece | Unknown — no user report |
